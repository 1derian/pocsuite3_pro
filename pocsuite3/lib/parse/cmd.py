...
def cmd_line_parser(argv=None):
    ...
    try:
        ...
        optimization.add_argument("--threads", dest="threads", type=int, default=20,
        ...
        diy.add_argument("--max-size", dest="max_size", type=int, default=10000,
                         help="Max size used in search fofa API")
        diy.add_argument("--save-file", dest="save_file", action="store", default=None,
                         help="save-file used in search fofa API")
